...
processors~\autocite{_measuringparallel_2016}.
...
It combines three software components: Warp (a framework for modeling plasma and
particle accelerators), AMRex (Adaptative Mesh Refinment library) and
...
A list of freqntly used simulation programs is given in \cref{tab:pic}. This list
is by no means exhaustive, but it should provide an overview of how different
features are addopted in PIC codes. A recent trend in HPC is the rise of
heterogenuous computing, involving mainly CPUs and GPUs, and thus the
...
\centering
  ...
  \midrule
  EPOCH & EM 3D & No & MPI\\
  Osiris & EM 3D, RZ\textsuperscript{F}, RZ** & Yes & MPI, OpenMP, SIMD\\
  Warp-X & EM 3D, PS*, RZ\textsuperscript{F}, RZ** & Yes & MPI, OpenMP, SIMD\\
...
code developed by the CCP-Plasma group.
