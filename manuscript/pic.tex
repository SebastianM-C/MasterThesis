...
the original continuous system in terms of symmetries and conserved quantities. %ref Dynamical systems and numerical analysis Andrew M. Stuart
...
\begin{equation}
  ...
  \begin{aligned}
    ...
    &- \frac{E_x^{n}(i+\frac{1}{2},j,k+1) -
      E_x^{n}(i+\frac{1}{2},j,k)}{\Delta z}
    + \frac{E_z^{n}(i+1,j,k+\frac{1}{2}) -
      E_z^{n}(i,j,k+\frac{1}{2})}{\Delta x}\,.
  \end{aligned}
\end{equation}
