...
processors~\autocite{sharcnet_measuringparallel_2016}.
...
features are adopted in PIC codes. A recent trend in HPC is the rise of
...
\centering
  ...
  Warp-X & EM 3D, PS\textsuperscript{l}, RZ\textsuperscript{F}, RZ\textsuperscript{FFT} & Yes & MPI, OpenMP, SIMD\\
...
\begin{itemize}
    ...
    \item RZ\textsuperscript{H}: Cylindrical geometry with Henkel transform in \(r\) direction
                and FFT-based pseudo-spectral method in \(z\) direction
    \item PS\textsuperscript{g}:\ Pseudo-spectral Maxwell solver with global Fourier transform
    \item PS\textsuperscript{l}: Pseudo-spectral Maxwell solver with domain decomposition and local Fourier transform
\end{itemize}
